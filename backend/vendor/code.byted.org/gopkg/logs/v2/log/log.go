...
var (
	...
	// CompatLogger is the default V1 compatible logger.
	CompatLogger *logs.CompatLogger
	// V1 is the alias of the CompatLogger
	V1 *logs.CompatLogger
	// V2 is the alias of the Logger.
	V2 *logs.ByteDLogger
)

func init() {
	Logger, V2 = logs.V2, logs.V2
	CompatLogger, V1 = logs.V1, logs.V1
}
...
// SecMarks add double brackets to the key-value pairs and return the generated string.
